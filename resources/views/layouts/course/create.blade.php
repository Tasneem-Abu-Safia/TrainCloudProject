                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <textarea class="form-control" name="desc" rows="2" required
                                      placeholder="Type a Description">{{ old('desc') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" class="form-control {{ $errors->has('course_num') ? 'is-invalid' : '' }}"
                                   name="course_num" id="course_num" value="{{ old('course_num') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <select class="form-control {{ $errors->has('duration_unit') ? 'is-invalid' : '' }}"
                                ...
                                <option value="weeks" {{ old('duration_unit') == 'weeks' ? 'selected' : '' }}>Weeks
                                </option>
                                <option value="months" {{ old('duration_unit') == 'months' ? 'selected' : '' }}>Months
                                </option>
                            </select>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <a type="button" href="{{ route('courses.index') }}"
                                   class="btn btn-white me-3">Back</a>
                            </div>
                        </div>
                    </div>
                </form>
